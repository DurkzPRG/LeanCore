...
Solo boot log: `LeanCore 1.2.1 setup (localHostMode=AUTO).` and `Runtime started profile=LITE`.
...
Learning snapshot: `mods/durkz_LeanCore/data/learning.state` (schema v4)
...
Output: `build/libs/LeanCore-1.2.1.jar`
